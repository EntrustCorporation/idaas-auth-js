...
export class AuthClient {
   ...
   * Ask user for the character at each coordinate (in order) to build the code, then call submit({ response: '<code>' }).
   *
  ...
  /**
   * Authenticate using a TOTP (Temporary one time password).
